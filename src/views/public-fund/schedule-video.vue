 ...
 * @LastEditTime: 2023-06-09 16:56:47
    ...
    <div class="adapter" id="adapter">
      <!-- 视频组件 -->
        <dhPlayer
          ...
          v-show="show"
          :imgsArr.sync="imgsArr"
          :dialogVisible.sync="dialogVisible"
        ></dhPlayer>
    </div>

    <el-dialog :visible.sync="dialogVisible" width="90%" class="dialog">
      <div class="imgBorder">
        <img
          class="imgs"
          v-for="(url, index) in imgsArr"
          :key="index"
          :src="url"
          alt=""
        />
...
<script>
import mixins from "@/mixins/viewMixins";
import Time from "../components/time/time.vue";
import  dhPlayer from  "../components/dh-player-schedule.vue"
export default {
  mixins: [mixins],
  components: {
    Time,
